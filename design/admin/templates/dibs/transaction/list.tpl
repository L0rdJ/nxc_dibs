...
if( typeof( MooTools ) != 'undefined' ) {
	window.addEvent( 'domready', function() {
		...
		var paginator = new NXC.Paginator.Simple( '#dibs-transactions-table tbody tr', options );
		paginator.build();
...
<div class="context-block">
	<div class="box-header"><div class="box-tc"><div class="box-ml"><div class="box-mr"><div class="box-tl"><div class="box-tr">
		<h1 class="context-title">&nbsp;{'DIBS Transactions'|i18n( 'extension/dibs' )} [{count( $transactions )}]</h1>
	...
	<div class="box-ml"><div class="box-mr"><div class="box-content">
		...
		<div class="content-navigation-childlist">
			<table id="dibs-transactions-table" class="list" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<th>{'ID'|i18n( 'extension/dibs' )}</th>
						<th>{'Date'|i18n( 'extension/dibs' )}</th>
						<th>{'Order'|i18n( 'extension/dibs' )}</th>
						<th>{'Customer'|i18n( 'extension/dibs' )}</th>
						<th>{'Customer IP'|i18n( 'extension/dibs' )}</th>
						<th>{'Status'|i18n( 'extension/dibs' )}</th>
						<th>&nbsp;</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="{$style}">
						...
						<td>
							<a href="{concat( 'dibs/details/', $transaction.id )|ezurl( 'no' )}"><img src="{'dibs/details.png'|ezimage( 'no' )}" alt="{'Details'|i18n( 'extension/dibs' )}" title="{'Details'|i18n( 'extension/dibs' )}" /></a>
						</td>
					</tr>
					{/foreach}
					{undef $order $user}
